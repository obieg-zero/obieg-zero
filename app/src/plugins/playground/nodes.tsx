...
import { Upload, FileText, Layers, Cpu, Globe, GitBranch, Filter, Shield, Tag, Check, AlertCircle } from 'react-feather'

const ICONS: Record<string, any> = { upload: Upload, embed: Layers, extract: Cpu, 'extract-api': Globe, graph: GitBranch, filter: Filter, validate: Shield, classify: Tag }
